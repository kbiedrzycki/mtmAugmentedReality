...
public class PendingInvitations extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        expListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v,
                ...
                new android.support.v7.app.AlertDialog.Builder(PendingInvitations.this)
                        .setMessage("What would you like to do with invitation?")
                        .setCancelable(true)
                        .setPositiveButton("Accept", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                new AcceptFriend().execute(friend.getId());
                            }
                        })
    ...
    private class LoadFriendsList extends AsyncTask<Void, Void, Friend[]> {
        ...
        protected void onPreExecute() {
            ...
            progress = ProgressDialog.show(PendingInvitations.this, "Wait", "Loading...", true);
        }
        ...
        protected Friend[] doInBackground(Void ...params) {
            ...
            query.add(new Param("invitations", "invitations"));
        ...
        protected void onPostExecute(Friend[] result) {
            ...
            if (result != null && apiInterceptor.error == null) {
                ...
                listDataHeader.add("Pending invitations");
                ...
                listDataChild.put(listDataHeader.get(0), pending);

                friendsListAdapter = new FriendsListAdapter(PendingInvitations.this, listDataHeader, listDataChild);
            ...
            if (apiInterceptor.error != null) {
                ...
                new AlertDialog.Builder(PendingInvitations.this)
                        .setTitle(title)
                        .setMessage(message)
    ...
    private class AcceptFriend extends AsyncTask<Integer, Void, Object> {
        APIInterceptor apiInterceptor = new APIInterceptor();
        ProgressDialog progress;
        ...
        protected Object doInBackground(Integer ...params) {
            ...
            query.add(new Param("token", appState.getSecurityToken()));
            query.add(new Param("from", Integer.toString(params[0])));
            ...
            if (apiInterceptor.error != null) {
                ...
                switch (apiInterceptor.error) {
                    ...
                    case APIInterceptor.NOT_A_FRIENDS:
                        ...
                        break;
                    case APIInterceptor.NOT_INVITED:
                        title = "Error";
                        message = "You have not been invited by that person";
